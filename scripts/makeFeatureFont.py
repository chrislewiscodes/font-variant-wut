...
sourceList = list('abcdefghijklmnopqrstuvwxyz')+['space', 'zero', 'one', 'two', 'three', 'four', 'five' ,'six', 'seven', 'eight', 'nine', 'braceleft', 'braceright']
substitutions = list('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz')
...
for i, tag in enumerate(tags):
    ...
    sub = substitutions[i]
    slugContents = ['braceleft'] + gnames + ['braceright']
    gname = 'tag_'+tag
